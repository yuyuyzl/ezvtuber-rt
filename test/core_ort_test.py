...
def CoreORTPerf():
    core = CoreORT('./data/tha3/seperable/fp32', rife_path='./data/rife_512/x4/fp32', device_id=0)#, cacher=Cacher(image_size=512), sr_path='data\\Real-ESRGAN\\exported_256_fp16', rife_path='./data/rife_512/x2/fp32',  device_id=1, cacher=Cacher(image_size=1024))
...
def CoreORTTestShow():
    core = CoreORT('./data/tha3/seperable/fp16',sr_path='data\\Real-ESRGAN\\exported_256_fp16', device_id=0)#, sr_path='data\\Real-ESRGAN\\exported_256_fp16', rife_path='./data/rife_512/x2/fp32',  device_id=1, cacher=Cacher(image_size=1024))
    core.setImage( cv2.imread('./test/data/base.png', cv2.IMREAD_UNCHANGED))
    with open('./test/data/pose_20fps.json', 'r') as file:
        pose_data = json.load(file)
